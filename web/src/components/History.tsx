...
const histories = [
    ...
    { date: new Date("2013/06/15"), title: "Twitter Bootstrap 利用にデザイン変更" },
    ...
    { date: new Date("2007/02/10"), title: "物理学科＞物理ゼミ＞全解答例一部訂正" },
    ...
    { date: new Date("2007/01/10"), title: "物理学科＞場の数理＞レポート訂正(２回目)" },
    { date: new Date("2006/12/25"), title: "物理学科＞場の数理＞レポート訂正" },
    { date: new Date("2006/12/20"), title: "物理学科＞数学Ａ＞線形空間・行列式演習訂正" },
    ...
    { date: new Date("2005/03/10"), title: "不評なのでトップページとバナーを改変。" },
    { date: new Date("2005/03/09"), title: "ソースコード失って開発できなくなったので「StudyTool」を一般公開。" },
